...
fun RecoveryDetailScreen(
    ...
    Column(
        ...
        FactorBreakdownCard(factors = listOf("Sleep Efficiency", "Heart Rate Variability", "Resting Heart Rate"))
        ActionGuidanceCard(guidance = "Your recovery is optimal. Safe to train hard today.")
    }
}
