...
fun StrainDetailScreen(
    ...
    Column(
        ...
        Text("Strain", style = MaterialTheme.typography.headlineMedium)
        ...
        FactorBreakdownCard(factors = listOf("Cardio Load", "Muscular Load"))
        ActionGuidanceCard(guidance = "Your strain is balanced. Consider a light active recovery tomorrow.")
    }
}
