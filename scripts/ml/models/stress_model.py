...
Stress Score ML model definition.

Input features (normalised 0.0–1.0):
    [hrv_norm, sleep_q_norm, steps_norm, cal_def_norm]

Output:
    [stress_score]  — single float, 0.0–1.0  (multiply by 100 for UI)
"""
...
FEATURE_COLS = ["hrv_norm", "sleep_q_norm", "steps_norm", "cal_def_norm"]
LABEL_COL    = "label"
